...
public class ListModel {
    private String data1,data2,data3,data4,data5,data6,data7,data8,data9,data10,data11,data12,
            data13,data14,data15,data16,data17,data18,data19,data20,data21,data22,data23,data24;

    private int data101,data102,data103;
    public ListModel() {
    }

    public ListModel(String data1, String data2) {
        this.data1 = data1;
        this.data2 = data2;
    }

    public ListModel(String data1, String data2, String data3) {
        this.data1 = data1;
        this.data2 = data2;
        this.data3 = data3;
    }

    public ListModel(String data1, String data2, String data3, String data4) {
        this.data1 = data1;
        this.data2 = data2;
        this.data3 = data3;
        this.data4 = data4;
    ...
    public ListModel(String data1, String data2, String data3, String data4, String data5) {
        this.data1 = data1;
        this.data2 = data2;
        this.data3 = data3;
        this.data4 = data4;
    ...
    public ListModel(String data1, String data2, String data3, String data4, String data5,
                     ...
                     String data16, String data17, String data18, String data19, String data20,
                     String data21, String data22, String data23, String data24) {
        this.data1 = data1;
        this.data2 = data2;
        this.data3 = data3;
        this.data4 = data4;
